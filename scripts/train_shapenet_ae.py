...
class_dir = os.path.join(top_in_dir)
print(class_dir)
...
# Load Validation set
for syn_id in os.listdir(top_in_dir):
    class_name = snc_synth_id_to_category[syn_id]
    print("Load validation set:%s %s"%(class_name, syn_id))
