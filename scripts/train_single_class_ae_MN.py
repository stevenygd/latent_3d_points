...
from latent_3d_points.src.in_out import PointCloudDataSet,load_all_point_clouds_under_folders
...
parser.add_argument('--dataset_dir', type=str, default="../data/ModelNet40.PC15k/", help='Dataset path.')
parser.add_argument('--output_dir', type=str, default="../expr/", help='Output path.')
parser.add_argument('--expr_prefix', type=str, default='ModelNet',
